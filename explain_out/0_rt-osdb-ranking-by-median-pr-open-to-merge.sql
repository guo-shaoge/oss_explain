...
"          └─TableReader_96","770.88","root","partition:pull_request_event","MppVersion: 1, data:ExchangeSender_95"
...
"                    └─Projection_64(Probe)","21926117.33","mpp[tiflash]","","gharchive_dev.github_events.created_at, gharchive_dev.github_events.pr_or_issue_created_at, cast(gharchive_dev.github_events.repo_id, double BINARY)->Column#134"
"                      └─Selection_66","21926117.33","mpp[tiflash]","","eq(gharchive_dev.github_events.action, ""closed""), eq(gharchive_dev.github_events.type, ""PullRequestEvent""), gt(div(cast(timestampdiff(""HOUR"", gharchive_dev.github_events.pr_or_issue_created_at, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 24), 0.1), not(like(gharchive_dev.github_events.actor_login, ""%bot%"", 92))"
