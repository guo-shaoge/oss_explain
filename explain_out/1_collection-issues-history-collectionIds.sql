...
"      │           └─Window_92","16.76","root","","row_number()->Column#97 over(partition by gharchive_dev.github_events.repo_id, gharchive_dev.github_events.number order by gharchive_dev.github_events.created_at rows between current row and current row)"
"      │             └─Sort_195","16.76","root","","gharchive_dev.github_events.repo_id, gharchive_dev.github_events.number, gharchive_dev.github_events.created_at"
"      │               └─Projection_124","16.76","root","","gharchive_dev.github_events.repo_id, date_format(gharchive_dev.github_events.created_at, %Y-%m-01)->Column#95, gharchive_dev.github_events.number, gharchive_dev.github_events.created_at"
...
"      │                   └─IndexReader_135(Probe)","16.76","root","partition:issues_event","index:IndexRangeScan_134"
