...
"    │ │   │           ├─IndexRangeScan_321(Build)","46.76","cop[tikv]","table:ge, index:index_ge_on_repo_id_created_at(repo_id, created_at)","range: decided by [eq(gharchive_dev.github_events.repo_id, gharchive_dev.github_repos.repo_id) ge(gharchive_dev.github_events.created_at, 2023-08-03 14:47:13) le(gharchive_dev.github_events.created_at, 2023-09-03 14:47:13)], keep order:false"
...
"              │ │               └─Projection_279","9445823.64","mpp[tiflash]","","plus(mul(div(cast(timestampdiff(SECOND, 2023-09-02 14:47:13, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 86400), 3), 2)->Column#535, gharchive_dev.github_events.repo_id, gharchive_dev.github_events.actor_id"
"              │ │                 └─Selection_198","9445823.64","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""WatchEvent""), ge(gharchive_dev.github_events.created_at, 2023-09-02 14:47:13), le(gharchive_dev.github_events.created_at, 2023-09-03 14:47:13)"
"              │ │                   └─TableFullScan_197","6349301992.00","mpp[tiflash]","table:ge","keep order:false, PartitionTableScan:true"
"              │ └─Selection_166(Probe)","1.31","root","","not(like(lower(gharchive_dev.github_repos.repo_name), ""%fuck%"", 92))"
"              │   └─TableReader_165","1.31","root","","data:Selection_164"
"              │     └─Selection_164","1.31","cop[tikv]","","eq(gharchive_dev.github_repos.is_deleted, 0), eq(gharchive_dev.github_repos.primary_language, ""Elixir""), gt(gharchive_dev.github_repos.forks, 5), gt(gharchive_dev.github_repos.pushed_at, 2023-06-03 14:47:13), gt(gharchive_dev.github_repos.stars, 5), lt(gharchive_dev.github_repos.created_at, 2023-09-02 14:47:13)"
...
"                              └─Projection_280","3651465.64","mpp[tiflash]","","plus(mul(div(cast(timestampdiff(SECOND, 2023-09-02 14:47:13, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 86400), 3), 1)->Column#538, gharchive_dev.github_events.repo_id, gharchive_dev.github_events.actor_id"
"                                └─Selection_257","3651465.64","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""ForkEvent""), ge(gharchive_dev.github_events.created_at, 2023-09-02 14:47:13), le(gharchive_dev.github_events.created_at, 2023-09-03 14:47:13)"
