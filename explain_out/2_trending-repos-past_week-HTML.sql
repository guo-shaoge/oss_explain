...
"    │ │   │           ├─IndexRangeScan_321(Build)","46.76","cop[tikv]","table:ge, index:index_ge_on_repo_id_created_at(repo_id, created_at)","range: decided by [eq(gharchive_dev.github_events.repo_id, gharchive_dev.github_repos.repo_id) ge(gharchive_dev.github_events.created_at, 2023-08-03 14:51:21) le(gharchive_dev.github_events.created_at, 2023-09-03 14:51:21)], keep order:false"
...
"        └─Projection_282","125686.32","root","","gharchive_dev.github_repos.repo_id, gharchive_dev.github_repos.repo_name, gharchive_dev.github_repos.description, gharchive_dev.github_repos.primary_language, gharchive_dev.github_repos.created_at, Column#141, Column#145, Column#185, Column#189, cast(plus(plus(Column#145, ifnull(Column#189, 0)), mul(div(1, cast(plus(1, timestampdiff(YEAR, gharchive_dev.github_repos.created_at, 2023-09-03 14:51:21)), decimal(20,0) BINARY)), 200)), decimal(65,4) BINARY)->Column#541"
"          └─HashJoin_137","125686.32","root","","CARTESIAN anti semi join, other cond:eq(gharchive_dev.github_repos.repo_name, gharchive_dev.blacklist_repos.name)"
"            ├─TableReader_277(Build)","6.00","root","","data:TableFullScan_276"
"            │ └─TableFullScan_276","6.00","cop[tikv]","table:br","keep order:false"
"            └─HashJoin_145(Probe)","157107.90","root","","left outer join, equal:[eq(gharchive_dev.github_repos.repo_id, gharchive_dev.github_events.repo_id)]"
...
"              │               └─Projection_280","3651465.64","mpp[tiflash]","","plus(mul(div(cast(timestampdiff(SECOND, 2023-08-27 14:51:21, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 604800), 3), 1)->Column#538, gharchive_dev.github_events.repo_id, gharchive_dev.github_events.actor_id"
"              │                 └─Selection_257","3651465.64","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""ForkEvent""), ge(gharchive_dev.github_events.created_at, 2023-08-27 14:51:21), le(gharchive_dev.github_events.created_at, 2023-09-03 14:51:21)"
"              │                   └─TableFullScan_256","6349301992.00","mpp[tiflash]","table:ge","keep order:false, PartitionTableScan:true"
"              └─IndexJoin_171(Probe)","157107.90","root","","inner join, inner:Selection_166, outer key:gharchive_dev.github_events.repo_id, inner key:gharchive_dev.github_repos.repo_id, equal cond:eq(gharchive_dev.github_events.repo_id, gharchive_dev.github_repos.repo_id), other cond:or(lt(gharchive_dev.github_repos.stars, 50000), gt(div(cast(Column#141, decimal(20,0) BINARY), cast(gharchive_dev.github_repos.stars, decimal(10,0) BINARY)), 0.01))"
...
"                │               └─Projection_279","9445823.64","mpp[tiflash]","","plus(mul(div(cast(timestampdiff(SECOND, 2023-08-27 14:51:21, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 604800), 3), 2)->Column#535, gharchive_dev.github_events.repo_id, gharchive_dev.github_events.actor_id"
"                │                 └─Selection_198","9445823.64","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""WatchEvent""), ge(gharchive_dev.github_events.created_at, 2023-08-27 14:51:21), le(gharchive_dev.github_events.created_at, 2023-09-03 14:51:21)"
"                │                   └─TableFullScan_197","6349301992.00","mpp[tiflash]","table:ge","keep order:false, PartitionTableScan:true"
"                └─Selection_166(Probe)","179.54","root","","not(like(lower(gharchive_dev.github_repos.repo_name), ""%fuck%"", 92))"
"                  └─TableReader_165","179.54","root","","data:Selection_164"
"                    └─Selection_164","179.54","cop[tikv]","","eq(gharchive_dev.github_repos.is_deleted, 0), eq(gharchive_dev.github_repos.primary_language, ""HTML""), gt(gharchive_dev.github_repos.forks, 5), gt(gharchive_dev.github_repos.pushed_at, 2023-06-03 14:51:21), gt(gharchive_dev.github_repos.stars, 5), lt(gharchive_dev.github_repos.created_at, 2023-09-02 14:51:21)"
