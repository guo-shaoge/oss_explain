...
"      ├─IndexRangeScan_23(Build)","158.73","cop[tikv]","table:ge, index:index_ge_on_actor_id_type_action_created_at_repo_id_commits(actor_id, type, action, created_at, repo_id, push_distinct_size)","range:[5086433 ""PushEvent"" """" 2023-08-31 14:50:41,5086433 ""PushEvent"" """" 2023-09-03 14:50:41], keep order:false"
