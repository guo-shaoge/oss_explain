...
"    │ │   │           ├─IndexRangeScan_321(Build)","46.76","cop[tikv]","table:ge, index:index_ge_on_repo_id_created_at(repo_id, created_at)","range: decided by [eq(gharchive_dev.github_events.repo_id, gharchive_dev.github_repos.repo_id) ge(gharchive_dev.github_events.created_at, 2023-08-03 14:39:42) le(gharchive_dev.github_events.created_at, 2023-09-03 14:39:42)], keep order:false"
...
"        └─Projection_282","2809.55","root","","gharchive_dev.github_repos.repo_id, gharchive_dev.github_repos.repo_name, gharchive_dev.github_repos.description, gharchive_dev.github_repos.primary_language, gharchive_dev.github_repos.created_at, Column#141, Column#144, Column#185, Column#188, cast(plus(plus(Column#144, ifnull(Column#188, 0)), mul(div(1, cast(plus(1, timestampdiff(YEAR, gharchive_dev.github_repos.created_at, 2023-09-03 14:39:42)), decimal(20,0) BINARY)), 200)), decimal(65,4) BINARY)->Column#541"
"          └─HashJoin_137","2809.55","root","","CARTESIAN anti semi join, other cond:eq(gharchive_dev.github_repos.repo_name, gharchive_dev.blacklist_repos.name)"
...
"              │ │               └─Projection_279","9445823.64","mpp[tiflash]","","plus(mul(div(cast(timestampdiff(SECOND, 2023-08-03 14:39:42, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 2678400), 3), 2)->Column#535, gharchive_dev.github_events.repo_id, gharchive_dev.github_events.actor_id"
"              │ │                 └─Selection_198","9445823.64","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""WatchEvent""), ge(gharchive_dev.github_events.created_at, 2023-08-03 14:39:42), le(gharchive_dev.github_events.created_at, 2023-09-03 14:39:42)"
...
"              │     └─Selection_164","4.01","cop[tikv]","","eq(gharchive_dev.github_repos.is_deleted, 0), eq(gharchive_dev.github_repos.primary_language, ""Scala""), gt(gharchive_dev.github_repos.forks, 5), gt(gharchive_dev.github_repos.pushed_at, 2023-06-03 14:39:42), gt(gharchive_dev.github_repos.stars, 5), lt(gharchive_dev.github_repos.created_at, 2023-09-02 14:39:42)"
...
"                              └─Projection_280","3651465.64","mpp[tiflash]","","plus(mul(div(cast(timestampdiff(SECOND, 2023-08-03 14:39:42, gharchive_dev.github_events.created_at), decimal(20,0) BINARY), 2678400), 3), 1)->Column#538, gharchive_dev.github_events.repo_id, gharchive_dev.github_events.actor_id"
"                                └─Selection_257","3651465.64","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""ForkEvent""), ge(gharchive_dev.github_events.created_at, 2023-08-03 14:39:42), le(gharchive_dev.github_events.created_at, 2023-09-03 14:39:42)"
