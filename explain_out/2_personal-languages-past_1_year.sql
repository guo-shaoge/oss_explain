...
"      │ └─IndexRangeScan_65","158.73","cop[tikv]","table:ge, index:index_ge_on_actor_id_type_action_created_at_repo_id_commits(actor_id, type, action, created_at, repo_id, push_distinct_size)","range:[5086433 ""PullRequestEvent"" ""opened"" 2022-09-03 14:45:19,5086433 ""PullRequestEvent"" ""opened"" 2023-09-03 14:45:19], keep order:false"
"      └─TableReader_33(Probe)","142.21","root","","data:Selection_32"
"        └─Selection_32","142.21","cop[tikv]","","ne(gharchive_dev.github_repos.primary_language, """"), not(isnull(gharchive_dev.github_repos.primary_language))"
