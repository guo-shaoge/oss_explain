...
"    │   │ └─HashAgg_246(Probe)","16.76","root","","group by:gharchive_dev.github_events.repo_id, funcs:count(distinct gharchive_dev.github_events.actor_login)->Column#136, funcs:firstrow(gharchive_dev.github_events.repo_id)->gharchive_dev.github_events.repo_id"
...
"    │   │     └─IndexReader_257(Probe)","16.76","root","partition:watch_event","index:IndexRangeScan_256"
...
"    │           └─CTEFullScan_338","13.41","root","CTE:stars_group_by_period AS sgp","data:CTE_1"
...
"            └─CTEFullScan_344","13.41","root","CTE:stars_group_by_period AS sgp","data:CTE_1"
...
"      └─Projection_163","16.76","root","","gharchive_dev.github_events.actor_login, gharchive_dev.github_events.created_at, gharchive_dev.github_events.repo_id, intdiv(datediff(2023-09-03, date(gharchive_dev.github_events.created_at)), 28)->Column#200, gharchive_dev.github_events.repo_id"
