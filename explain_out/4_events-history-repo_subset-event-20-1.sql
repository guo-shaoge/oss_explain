...
"                    └─Projection_45(Probe)","34104108.03","mpp[tiflash]","","gharchive_dev.github_events.repo_id, cast(gharchive_dev.github_events.repo_id, double BINARY)->Column#43"
"                      └─Selection_47","34104108.03","mpp[tiflash]","","eq(gharchive_dev.github_events.type, ""event""), ge(gharchive_dev.github_events.event_year, 2022)"
